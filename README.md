...
```
cd existing_repo
git remote add origin https://gitlab.com/finantaged1/fund4crypto.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/finantaged1/fund4crypto/-/settings/integrations)
